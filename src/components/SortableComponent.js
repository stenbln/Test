...
const SortableItem = SortableElement(({value,dataitemID}) => {
    return (
      <div className="mainDiv">
          <div className="item">
              <EditableDiv dataitemID={dataitemID} textValue={value}></EditableDiv>
          </div>
...
class SortableComponent extends Component {
    ...
    updateSortables(items){
        SortableActions.updateSortables(items);
    }
    ...
    render() {
        return (
          <div id="sortableDiv">
            <SortableList items={this.props.items} lockAxis="y" useDragHandle={true} onSortEnd={this.onSortEnd} />
          </div>
        )
    }
}
