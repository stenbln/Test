...
var StackedMyVideos = React.createClass({
            ...
            return (
              <div style={styles.container} key={'video_preview_id'+i}>
                ...
                <div className="compositionInfoDiv" data-infodiv="true">
                    <div>Scene {this.props.dataitemID+1} <a href={cap.original.url} download={cap.original.url}><i style={styles.faicon}className="fa  fa-cloud-download" aria-hidden="false"></i></a> </div>
                </div>
              </div>)
...
module.exports = StackedMyVideos;
//export default App;
