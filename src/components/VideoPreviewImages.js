...
const VideoPreviewImages = React.createClass({
  handleClick(evt){
  ...
  render(){
    return <div data-imageId={this.props.index} onClick={this.handleClick} ref={(el)=>{this.attachListeners(el,this.props.currentActiveBar,this.props.index)} } className="imagePlaceholder videoAnimated"></div>
  }
});

module.exports = VideoPreviewImages;